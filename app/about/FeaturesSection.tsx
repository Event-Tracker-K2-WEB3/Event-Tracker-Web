  ...
  return (
    <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24 border-t border-purple-500/10">
      <div className="space-y-12">
        <h2 className="text-3xl sm:text-4xl font-bold tracking-tight text-center lg:text-left">Ce que propose la plateforme</h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <Link href="/events" className="group flex flex-col justify-between sm:flex-row items-center gap-6 p-6 rounded-2xl bg-[#13132b] border border-white/5 hover:border-purple-500/40 hover:bg-[#181836] transition-all duration-300">
            <div className="space-y-3 flex-1">
              ...
              <h3 className="text-xl font-bold group-hover:text-purple-400 transition-colors">Événements</h3>
              <p className="text-gray-400 text-sm font-light leading-relaxed">Découvrez tous les événements à venir et trouvez celui qui vous correspond.</p>
            </div>
          ...
          <Link href="/planning" className="group flex flex-col justify-between sm:flex-row items-center gap-6 p-6 rounded-2xl bg-[#13132b] border border-white/5 hover:border-purple-500/40 hover:bg-[#181836] transition-all duration-300">
            <div className="space-y-3 flex-1">
              ...
              <h3 className="text-xl font-bold group-hover:text-purple-400 transition-colors">Planning</h3>
              <p className="text-gray-400 text-sm font-light leading-relaxed">Consultez le programme global et les plannings détaillés par salle et par jour.</p>
            </div>
            <div className="relative w-full sm:w-[200px] h-[150px] rounded-xl overflow-hidden flex-shrink-0">
              <Image 
                src="/event.png"
          ...
          <Link href="/speakers" className="group flex flex-col justify-between sm:flex-row items-center gap-6 p-6 rounded-2xl bg-[#13132b] border border-white/5 hover:border-purple-500/40 hover:bg-[#181836] transition-all duration-300">
            <div className="space-y-3 flex-1">
              ...
              <h3 className="text-xl font-bold group-hover:text-purple-400 transition-colors">Intervenants</h3>
              <p className="text-gray-400 text-sm font-light leading-relaxed">Accédez aux profils des intervenants et retrouvez leurs sessions en un clic.</p>
            </div>
            <div className="relative w-full sm:w-[200px] h-[150px] rounded-xl overflow-hidden flex-shrink-0">
              <Image 
                src="/intervenant.png"
