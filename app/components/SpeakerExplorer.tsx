...
const DOMAINS = ["All", "IA", "Web", "Cloud", "Cybersecurity", "Mobile"];
...
export default function SpeakerExplorer({ speakers }: SpeakerExplorerProps) {
  ...
  const filteredSpeakers = useMemo(() => {
    ...
    if (day !== "All") {
      const storedDay = day.replace("Day", "Jour");
      result = result.filter((speaker) => speaker.day === day || speaker.day === storedDay);
    }
